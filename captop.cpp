...
struct BettiOptions { std::string out_dir="captop_betti_out"; bool overwrite=false, force=false, write_diagram=false, write_json=false, write_csv=false, quiet=false, require_gudhi=false, allow_fallback=true; double max_memory_gb=2.0; int field=2; };
struct BettiResult { bool success=false,gudhi_compiled=false,gudhi_used=false,gudhi_success=false,fallback_used=true,topology_authoritative=false; TopologySource topology_source=TopologySource::NONE; std::string result_authority,readiness_stage6; int H0=0,H1=0,H2=0,H3=0,H0_union_find=0,H2_complement=-1; long long result_chi=0,chi_cells=0,occupied_voxels=0,missing_voxels=0,total_voxels=0,surface_voxels=0,surface_faces=0,C0=0,C1=0,C2=0,C3=0; double occupied_fraction=0; std::string H0_source,H1_source,H2_source,H3_source,chi_source; std::vector<std::string> warnings,errors; };
