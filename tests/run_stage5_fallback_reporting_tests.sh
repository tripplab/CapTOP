...
assert_contains "$out/captop_betti_report.txt" "H1 tunnels          : 1  [inferred from H0 + H2 - chi]"
...
assert data['topology']['H1_source']=='inferred_from_euler'
PY
...
('topology','H0_source'): 'union_find_face_adjacency', ('topology','H1_source'): 'inferred_from_euler', ('topology','H2_source'): 'complement_flood_fill',
...
required=['gudhi_compiled','gudhi_used','gudhi_success','fallback_used','topology_source','topology_authoritative','coefficient_field_requested','coefficient_field_used','H0_source','H1_source','H2_source','H3_source','chi_source','stage6_ready']
missing=[c for c in required if c not in row]
assert not missing, missing
expected={'gudhi_compiled':'false','gudhi_used':'false','gudhi_success':'false','fallback_used':'true','topology_source':'fallback_diagnostic','topology_authoritative':'false','coefficient_field_requested':'2','coefficient_field_used':'NA','stage6_ready':'false'}
